...
public class fligth extends javax.swing.JFrame {
   ...
   int q,i,id,deleteItem;
    ...
    try{
      ...
      pst = (PreparedStatement) sqlConn.prepareStatement("select * from flight");
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        Class.forName("com.mysql.jdbc.Driver");
      sqlConn = DriverManager.getConnection(dataConn,username,password);
      pst = (PreparedStatement) sqlConn.prepareStatement("update flight set Fcode=?,Fsource=?, Fdestination=?,Fdate=?,Fseat=? where Fcode=?");
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        Class.forName("com.mysql.jdbc.Driver");
      sqlConn = DriverManager.getConnection(dataConn,username,password);
      pst = (PreparedStatement) sqlConn.prepareStatement("insert into flight(Fcode, Fsource,Fdestination,Fdate,Fseat)values(?,?,?,?,?)");
...
//        updateId=Integer.parseInt(recd);
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if(deleteItem == JOptionPane.YES_OPTION){
            Class.forName("com.mysql.jdbc.Driver");
      sqlConn = DriverManager.getConnection(dataConn,username,password);
      pst = (PreparedStatement) sqlConn.prepareStatement("delete from flight where Fcode=?");
      String myid = Fcode.getText();
      pst.setString(1, myid);
      pst.executeUpdate();
