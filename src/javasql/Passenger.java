...
int q,i,id,deleteItem;
   ...
   public void display() 
    ...
    try{
      ...
      pst = (PreparedStatement) sqlConn.prepareStatement("select * from passenger");
    ...
    private void initComponents() {
        ...
        backBtn.setIcon(new javax.swing.ImageIcon("C:\\Users\\UR PC\\Documents\\NetBeansProjects\\Javasql\\icon\\icons8-back-arrow-30.png")); // NOI18N
...
private void clear(){
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        Class.forName("com.mysql.jdbc.Driver");
      sqlConn = DriverManager.getConnection(dataConn,username,password);
      pst = (PreparedStatement) sqlConn.prepareStatement("insert into passenger(Pname, Pnationality,Pgender,Ppassport,Paddress, Pphone)values(?,?,?,?,?,?)");
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        Class.forName("com.mysql.jdbc.Driver");
      sqlConn = DriverManager.getConnection(dataConn,username,password);
      pst = (PreparedStatement) sqlConn.prepareStatement("update passenger set Pname=?, Pnationality=?,Ppassport=?,Pgender=?,Paddress=?, Pphone=? where Pid=?");
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        if(deleteItem == JOptionPane.YES_OPTION){
            Class.forName("com.mysql.jdbc.Driver");
      sqlConn = DriverManager.getConnection(dataConn,username,password);
      pst = (PreparedStatement) sqlConn.prepareStatement("delete from passenger where Pid=?");
